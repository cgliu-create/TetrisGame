...
public class gridZShape {
    ...
    public void reset(){
        ...
        group[2][0][0]=2; group[2][0][1]=3; group[2][0][2]=2;
        group[2][1][0]=2; group[2][1][1]=4; group[2][1][2]=3;
    ...
    public void add(int[][][] data){
        data[0][3][2] = 3; data[0][4][2] = 2; data[0][5][2] = 0; data[0][6][2] = 0;
        data[1][3][2] = 2; data[1][4][2] = 2; data[1][5][2] = 0; data[1][6][2] = 0;
        data[2][3][2] = 2; data[2][4][2] = 3; data[2][5][2] = 0; data[2][6][2] = 0;
    ...
    public void rotOne(){
        ...
        group[2][0][2]=2; group[2][1][2]=3; group[2][2][2]=0; group[2][3][2]=0;
        group[3][0][2]=0; group[3][1][2]=0; group[3][2][2]=0; group[3][3][2]=0;
    }
    public void rotTwo(){
        group[0][0][2]=2; group[0][1][2]=2; group[0][2][2]=3; group[0][3][2]=0;
        group[1][0][2]=3; group[1][1][2]=2; group[1][2][2]=2; group[1][3][2]=0;
        group[2][0][2]=0; group[2][1][2]=0; group[2][2][2]=0; group[2][3][2]=0;
        group[3][0][2]=0; group[3][1][2]=0; group[3][2][2]=0; group[3][3][2]=0;
    }
    public void rotThree(){
        group[0][0][2]=0; group[0][1][2]=3; group[0][2][2]=2; group[0][3][2]=0;
    ...
    public void rotFour(){
        ...
        group[1][0][2]=2; group[1][1][2]=2; group[1][2][2]=3; group[1][3][2]=0;
        group[2][0][2]=3; group[2][1][2]=2; group[2][2][2]=2; group[2][3][2]=0;
        group[3][0][2]=0; group[3][1][2]=0; group[3][2][2]=0; group[3][3][2]=0;
    }
