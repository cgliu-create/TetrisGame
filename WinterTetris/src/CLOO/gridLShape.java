...
public class gridLShape {
    ...
    public void reset(){
        ...
        group[1][0][0]=1; group[1][0][1]=3; group[1][0][2]=3;
    ...
    public void rotTwo(){
        group[0][0][2]=3; group[0][1][2]=3; group[0][2][2]=2; group[0][3][2]=0;
    ...
    public void rotThree(){
        ...
        group[2][0][2]=0; group[2][1][2]=2; group[2][2][2]=2; group[2][3][2]=0;
        group[3][0][2]=0; group[3][1][2]=0; group[3][2][2]=0; group[3][3][2]=0;
    }
    public void rotFour(){
        group[0][0][2]=0; group[0][1][2]=0; group[0][2][2]=0; group[0][3][2]=0;
        group[1][0][2]=2; group[1][1][2]=2; group[1][2][2]=2; group[1][3][2]=0;
        group[2][0][2]=2; group[2][1][2]=3; group[2][2][2]=3; group[2][3][2]=0;
        group[3][0][2]=0; group[3][1][2]=0; group[3][2][2]=0; group[3][3][2]=0;
    }
